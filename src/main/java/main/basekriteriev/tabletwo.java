...
// Реализация интерфейса для второй таблицы
public class tabletwo implements CommonTableData {
    private int id;
    private String B1;
    private String B2;
    private String B3;
    ...
    public tabletwo(int id, String B1, String B2, String B3, String B4, String B5, String B6 , String B7, String B8, String B9, String B10, String B11, String B12 ) {
        this.id = id;
        this.B1 = B1;
        this.B2 = B2;
        this.B3 = B3;
    ...
    @Override
    public void setB6(String value) {this.B6 = value;}
    ...
    @Override
    public void setB12(String value) {this.B12 = value;}
